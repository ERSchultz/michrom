...
python3 scripts/diffusion_analysis.py --dir $dir --odir $odir --jobs $jobs --down_sampling $downSampling --its $its --scratch $scratch --chunk_size $chunkSize --plot $plot --update_mode $updateMode --k $k
